  ...
  return (
    <PopoverPrimitive.Portal container={dialogContainer}>
      <PopoverPrimitive.Content
        ...
        // Khi portal vào trong Dialog: DialogContent có transform (containing block) +
        // overflow-y-auto nên sẽ CẮT popover. Đặt collisionBoundary = DialogContent để
        // Radix lật/thu gọn popover cho vừa trong khung, tránh bị che.
